export const PERMISSIONS = {
  ...
  MANAGE_TENDER_TYPES:'MANAGE_TENDER_TYPES',
} as const;
...
export const PERMISSION_CATEGORIES: Record<string, { label: string; permissions: PermissionKey[] }> = {
  ...
  masters: {
    label: 'Masters',
    permissions: [PERMISSIONS.MANAGE_BRANDS, PERMISSIONS.MANAGE_SUPPLIERS, PERMISSIONS.MANAGE_ASSET_TYPES, PERMISSIONS.MANAGE_TENDERS, PERMISSIONS.MANAGE_TENDER_TYPES],
  },
  users: {
    label: 'Users & Roles',
